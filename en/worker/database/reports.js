...
async function handleDimensionReport(db, user, filters, dimensionType, label) {
  ...
  return {
    columns: [
      { key: 'dimensionId', label: `${label} ID` }, { key: 'currency', label: 'Currency' },
      { key: 'views', label: 'Views' }, { key: 'clicks', label: 'Clicks' },
      { key: 'conversions', label: 'Conversions' }, { key: 'revenue', label: 'Revenue' },
      { key: 'commission', label: 'Commission' }, { key: 'ctr', label: 'CTR' },
      { key: 'cvr', label: 'CVR' }, { key: 'epc', label: 'EPC' },
      { key: 'rpc', label: 'RPC' }, { key: 'cpa', label: 'CPA' }
    ],
    rows
  };
}
...
async function handleAffiliatePerformance(db, user, filters) {
  ...
  return {
    columns: [
      { key: 'level', label: 'Level' }, { key: 'dimensionId', label: 'ID' },
      { key: 'currency', label: 'Currency' }, { key: 'clicks', label: 'Clicks' },
      { key: 'conversions', label: 'Conversions' }, { key: 'revenue', label: 'Revenue' },
      { key: 'commission', label: 'Commission' }, { key: 'cvr', label: 'CVR' },
      { key: 'epc', label: 'EPC' }, { key: 'cpa', label: 'CPA' }
    ],
    rows
  };
}
...
async function handleGeoPerformance(db, user, filters) {
  ...
  return {
    columns: [
      { key: 'country', label: 'Country' }, { key: 'clicks', label: 'Clicks' },
      { key: 'conversions', label: 'Conversions' }, { key: 'revenue', label: 'Revenue' },
      { key: 'commission', label: 'Commission' }, { key: 'cvr', label: 'CVR' },
      { key: 'epc', label: 'EPC' }
    ],
...
async function handleContentPerformance(db, user, filters) {
  ...
  return {
    columns: [
      { key: 'contentType', label: 'Content Type' }, { key: 'dimensionId', label: 'ID' },
...
async function handleTrafficPerformance(db, user, filters) {
  ...
  return {
    columns: [
      { key: 'date', label: 'Date' }, { key: 'views', label: 'Views (all content)' },
      { key: 'clicks', label: 'Affiliate Clicks' }, { key: 'ctr', label: 'CTR' },
      { key: 'conversions', label: 'Conversions' }, { key: 'revenue', label: 'Revenue' },
...
async function handleConversionFunnel(db, user, filters) {
  ...
  return {
    columns: [
      { key: 'casinoId', label: 'Casino ID' }, { key: 'views', label: 'Views' },
...
async function handleRevenueCommission(db, user, filters) {
  ...
  return {
    columns: [
      { key: 'casino_id', label: 'Casino ID' }, { key: 'currency', label: 'Currency' },
      { key: 'status', label: 'Status' }, { key: 'conversions', label: 'Conversions' },
      { key: 'revenue', label: 'Revenue' }, { key: 'commission', label: 'Commission' }
    ],
    rows: result.results || []
  };
}
...
export async function runReport(db, user, reportType, filters) {
  ...
  return await handler(db, user, filters);
}
